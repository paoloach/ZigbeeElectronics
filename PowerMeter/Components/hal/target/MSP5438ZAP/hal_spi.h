...
#define HAL_SPI_SS_ON()                    st( P3OUT &= 0xFE; )
#define HAL_SPI_SS_OFF()                   st( P3OUT |= 0x01; )

#define HAL_SPI_WRITE_BYTE(X)              st( UCB0IFG &= ~UCRXIFG;  UCB0TXBUF = (X); )
#define HAL_SPI_READ_BYTE()                UCB0RXBUF
#define HAL_SPI_WAIT_DONE()                while(!(UCB0IFG & UCRXIFG));
